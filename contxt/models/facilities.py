...
class Query(Type):
    ...
    metric_data = Field(MetricDataConnection, graphql_name='metricData', args=
    {
...
class Mutation(Type):
    create_facility = Field(CreateFacilityPayload, graphql_name='createFacility', args={'input': Arg(non_null(CreateFacilityInput))})