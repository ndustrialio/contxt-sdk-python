...
def query_main_services():
    ...
    _op_main_services_nodes_usage = _op_main_services_nodes.data_point_by_demand(__alias__='usage')
    ...
    _op_main_services_nodes_demand = _op_main_services_nodes.data_point_by_usage(__alias__='demand')
